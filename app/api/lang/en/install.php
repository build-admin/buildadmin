...
return [
    ...
    'Mysqli and PDO extensions need to be installed'                                                                     => 'Need to install the extensions of Mysqli and PDO.',
    'Popen and Pclose functions in PHP Ini is disabled'                                                                  => 'These two functions of Popen and Pclose were disabled in PHP.Ini.',
    'How to modify'                                                                                                      => 'How to modify?',
    'Click to view how to modify'                                                                                        => 'Click to see how to modify.',
    'Security assurance?'                                                                                                => 'Security assurance?',
    'Using the installation service correctly will not cause any potential security problems. Click to view the details' => 'Proper use of the installation service will not cause any potential security issues, click to view the details.',
    'Feof and fgets functions in PHP Ini is disabled'                                                                    => 'These two functions of Feof and Fgets were disable in php.ini.',
