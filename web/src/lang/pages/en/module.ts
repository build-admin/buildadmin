export default {
    ...
    'Dependency recovery warning 1': 'After disabling, the system dependencies will be restored to the module ',
    'Dependency recovery warning 2': 'before installation',
    'Dependency recovery warning 3': ' Please pay attention to backup!',
    'composer and package The JSON file will be restored': 'composer. JSON and Web / package The JSON file will be restored',
