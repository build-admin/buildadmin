export default {
    ...
    'One line at a time, without quotation marks, for example: key1=value1': 'One in a line , No quotation marks required, for example: key1=value1',
    'Validation rules': 'Validation rules',
    'Extended properties': 'Extended properties',
    'One attribute per line without quotation marks': 'One attribute per line, No quotation marks required, for example: class=config-item',
    weight: 'Weight',
    number: 'Number',
