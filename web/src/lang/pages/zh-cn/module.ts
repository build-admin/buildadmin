export default {
    ...
    'Dependency recovery warning 1': '禁用后，系统依赖项将被还原到模块',
    'Dependency recovery warning 2': '安装之前',
    'Dependency recovery warning 3': '，请注意备份！',
    'composer and package The JSON file will be restored': 'composer.json 和 web/package.json 文件将被还原',
